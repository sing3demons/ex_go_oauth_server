...
const (
	clientID     = "b836d40c-291c-427c-bd94-c21224dd0b97"         // เปลี่ยนเป็น ClientID ของคุณจาก DB
	clientSecret = "PAINoOUGGkZsJmFzv35VaxpDUmBI_p5kRvJhY-ODUbY=" // เปลี่ยนเป็น Secret ของคุณ
